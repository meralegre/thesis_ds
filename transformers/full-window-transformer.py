    ...
    for name in melody_names:
        ...
        for t in range(max_len):
            if mask[t]:
                ...
                # Predicted pitch
                predicted_token = int(np.argmax(probs[0][t]))
                ...
                rows.append({
                    ...
                    "correct_pitch": predicted_pitch == mel[original_pos],
                    "ic": ic,
                })
                note_idx += 1
...
if __name__ == "__main__":
    ...
    if args.experiment == "full_essen":
	    ...
	    max_len=max_len,
            ...
            save_models_dir=args.save_models_dir or "../pretrained_models/full_window/full_window_essen",
        )
    ...
    # ------------------------------------------------------------------
        ...
        model, history, data_info = train_model(
            ...
            epochs=args.epochs,
            patience=args.patience,
            save_models_dir=args.save_models_dir or "../pretrained_models/full_window/full_window_meertens",
        )
    ...
    # ------------------------------------------------------------------
        ...
        run_kfold(
            ...
            save_models_dir=args.save_models_dir or "../pretrained_models/full_window/kfold_full_essen",
        )
    ...
    # ------------------------------------------------------------------
        ...
        run_kfold(
            ...
            save_models_dir=args.save_models_dir or "../pretrained_models/full_window/kfold_full_meertens",
        )
    ...
    # ------------------------------------------------------------------
        ...
        run_cross_corpus(
            ...
            save_models_dir=(
                ...
                or "../pretrained_models/full_window/cross_corpus_full_essen2meertens"
            )
        )
    ...
    # ------------------------------------------------------------------
        ...
        run_cross_corpus(
            ...
            save_models_dir=(
                args.save_models_dir
                or "../pretrained_models/full_window/cross_corpus_full_meertens2essen"
            )
        )
    ...
    # ------------------------------------------------------------------
        ...
        run_hymn_ic(
            model_dir=args.trained_model_dir or "../pretrained_models/full_window/full_window_essen",
